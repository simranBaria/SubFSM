...
namespace NodeCanvas.Tasks.Actions {
	...
	public class WalkingAT : ActionTask {
		public float changeInThirst, changeInPee;

		public BBParameter<Transform> target;
		public BBParameter<float> walkSpeed, thirstLevel, peeLevel;
		...
		protected override void OnUpdate() {
			// Walk to target
			agent.transform.position += Time.deltaTime * walkSpeed.value * (target.value.position - agent.transform.position).normalized;
